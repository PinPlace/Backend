current issue with save locations of media. Currentl places them in the base directory vs the media folder, hence the default.png is located there for now to show that it at least renders correctly
